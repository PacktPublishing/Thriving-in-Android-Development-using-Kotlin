    ...
    Box(
        ...
        if (isCasting.value) {
            ...
            if (isControlsVisible.value) {
                TopMediaRow(
                    mediaRouter = MediaRouter.getInstance(LocalContext.current),
...
@Composable
fun TopMediaRow(mediaRouter: MediaRouter, modifier: Modifier = Modifier) {
    Row(
        modifier = modifier
            .fillMaxWidth()
            .padding(20.dp),
        ...
        MediaRouteDiscoveryOptions(mediaRouter = mediaRouter)
    }
}
